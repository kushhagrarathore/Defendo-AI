  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <input
            ...
            placeholder="Search by ID, service, city..."
      ...
      <GlassCard className="overflow-hidden">
        <div className="grid grid-cols-8 px-4 py-3 text-white/60 text-sm border-b border-[#29382f]">
          <div>ID</div>
          <div>Service</div>
          <div>Date/Time</div>
          <div>Location</div>
        ...
        {loading ? (
          ...
          <div className="divide-y divide-[#29382f]">
            {filtered.map(b => (
              <div key={b.id} className="grid grid-cols-8 px-4 py-3 items-center hover:bg-[#1a241e]">
                <div>#{b.id}</div>
                ...
                <div className="text-right">
                  <button className="text-[var(--primary-color)] hover:underline" onClick={() => setSelected(b)}>View</button>
                </div>
              </div>
            ))}
          </div>
