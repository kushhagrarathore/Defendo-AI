          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            {founders.map((founder, index) => (
              ...
              >
                ...
                <div className="w-[462px] h-[462px] bg-gradient-to-br from-[var(--primary-color)]/30 to-white/10 rounded-xl mx-auto mb-4 flex items-center justify-center overflow-hidden">
    {founder.image ? (
